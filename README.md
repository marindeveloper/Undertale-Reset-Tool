...
> **⚠️ Antivirus Note:** Some antivirus software may flag the EXE as a false positive. This is a common issue with Python apps built with PyInstaller. You can verify the safety by checking the source code here (it's only 283 lines so), by uploading it to virustotal (Scores 3/72, all 3 are false positives and from unknown antiviruses) or well you can do anything you want lol it's open source.
